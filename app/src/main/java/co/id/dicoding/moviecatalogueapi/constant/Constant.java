...
public interface Constant {
    ...
    String KEY_PREFS = "co.id.dicoding.moviecatalogueapi";
    String KEY_PREF_RELEASE_REMINDER = "release_notif_config";
    String KEY_PREF_DAILY_REMINDER = "daily_notif_config";
    String KEY_APP_WIDGET_ID = "appWidgetId";
